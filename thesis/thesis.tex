...
\apstr{%
U ovom radu će biti predstavljen razvoj skalabilnog veb-servisa zasnovanog na arhitekturi bez servera. Za razvoj veb-servisa koristiće se programski jezik NodeJs, pomoću kojega ćemo napisati funkcije za servis \emph{AWS Lambda}. Za bazu podataka koristiće se servis \emph{AWS DynamoDB}. Kôd će biti postavljen na veb-servis putem serverless alata. Za autentifikaciju i autorizaciju koristiće se servis platforme \emph{AWS} pod nazivom \emph{AWS Cognito}. Za razvoj Android mobilne aplikacije koristiće se programski jezik Kotlin.
}
