...
\apstr{%
U ovom radu će biti predstavljen razvoj skalabilnog veb servisa zasnovanih na arhitekturi bez servera. Za razvoj veb servisa koristićemo NodeJs programski jezik pomoću kojega ćemo napisati funkcije za AWS Lambda servis. Za bazu podataka ćemo koristiti AWS DynamoDb servis. Kôd će biti postavljen na veb servis putem serverless alata. Za autentifikaciju i autorizaciju koristimo AWS servis pod nazivom AWS Cognito. Za razvoj android mobilne aplikacije koristimo programski jezik Kotlin.
}
